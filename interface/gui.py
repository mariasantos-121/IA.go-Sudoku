...
def rodar_interface():
    ...
    while running:
        ...
        # Processar resultado da thread de resolução
        ...
        # Faz quebra de linha do status se for muito grande
